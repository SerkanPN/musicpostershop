...
interface CassettePosterPageProps {
  navigate: (path: string) => void;
}

export default function CassettePosterPage({ navigate }: CassettePosterPageProps) {
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col items-center justify-center p-6 font-sans">
      <div className="text-center max-w-md bg-zinc-900 border border-zinc-800 p-8 rounded-3xl shadow-2xl">
        <h1 className="text-2xl font-black uppercase mb-2 tracking-wider text-indigo-400">Retro Cassette Tape</h1>
        <p className="text-zinc-400 text-xs mb-6 leading-relaxed">
          Nostalgic 80s mixtape designs customized with your own text and colors. Editor setup coming soon.
        </p>
